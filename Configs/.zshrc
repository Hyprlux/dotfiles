...
alias  l='eza -lg  --icons=auto' # long list
alias ls='eza -1g  --icons=auto' # short list
alias ll='eza -lga --icons=auto' # long list all
alias ld='eza -lgD --icons=auto' # long list dirs
