...
const updateAll_1 = require("../../updateAll");
...
suite('UpdateAll Test Suite', () => {
    test('When all releases are prereleases', async function () {
        ...
        (0, npm_1.setCachedNpmData)(npmCache);
        const result = (0, updateAll_1.updateAll)(textDocument);
        assert.deepStrictEqual(JSON.stringify(result), JSON.stringify(expected));
    });
});
//# sourceMappingURL=updateAll.test.js.map