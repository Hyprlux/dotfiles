...
tmpMapDir="/tmp"
tmpMap="$tmpMapDir/hyprlux-keybinds.jq"
keycodeFile="${hyprluxConfDir}/keycode.kb"
modmaskFile="${hyprluxConfDir}/modmask.kb"
keyFile="${hyprluxConfDir}/key.kb"
categoryFile="${hyprluxConfDir}/category.kb"
dispatcherFile="${hyprluxConfDir}/dispatcher.kb"
...
Users can also add a global overrides inside ${hyprluxConfDir}/hyprlux.conf
  Available overrides:
...
Users can also add a key overrides inside ${hyprluxConfDir}
