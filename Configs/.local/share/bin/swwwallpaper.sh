...
lockFile="/tmp/hyprlux$(id -u)$(basename ${0}).lock"
...
wallSet="${hyprluxThemeDir}/wall.set"
...
setIndex=0
[ ! -d "${hyprluxThemeDir}" ] && echo "ERROR: \"${hyprluxThemeDir}\" does not exist" && exit 0
wallPathArray=("${hyprluxThemeDir}")
